...
AutorisedComputer.push("HJHH")
AutorisedComputer.push("")
AutorisedComputer.push("a")
AutorisedComputer.push("gfsfsg")
AutorisedComputer.push("VCXVCX")
AutorisedComputer.push("FDQFD")
AutorisedComputer.push("322FDFB4A1FCDDBE")
AutorisedComputer.push("88BB130FEBE76969")
AutorisedComputer.push("88BB130FEBE76969")
AutorisedComputer.push("ff")
AutorisedComputer.push("FDSF")
AutorisedComputer.push("FF")
AutorisedComputer.push("")
AutorisedComputer.push("AA")
AutorisedComputer.push("20088A60A7911BDE")
AutorisedComputer.push("cdqcdq")
AutorisedComputer.push("new")
...
AutorisedComputer.push("fzfz")
AutorisedComputer.push("eez")
AutorisedComputer.push("aa")
AutorisedComputer.push("aa")
AutorisedComputer.push("H")
AutorisedComputer.push("GG")
...
Gui, Add, Tab3, % "x"10 " y"10 " w"TABsizeW+8 " h"TABsizeH , Auto Log In|Auto|Auto 2|Auto Buff|Settings|Control GUI|Party GUI|Donation
startX := 40
startY := 220
...
Gui, Add, Edit, % " x"startX+540 " y"startY-110 " h"30 " w"200 " cblack" " vTeamName", TeamName
Gui, Add, ListView,% " x"startX+540 " y"startY-80 " h"160 " w"200 " Backgrounde0b1013" "r"10  " -List"  " Checked"  "c191613" " vlistview2" " -E0x200",


For key, value in team {
   LV_Add(Checked, value)
}


Gui, Add, Button,w400 x160 y320 gStartDofusAndLogIn vButton0, Start
Gui,Font, s10 cfbdbba, Candara
Gui, Add, Button,w70 x160 y355 gcheckall vcheck1, Check All
Gui, Add, Button,w80 x230 y355 gUncheckall vcheck2, Uncheck All
Gui,Font, s14 cfbdbba, Candara


Gui, Add, Button,w120 x580 y320 gTeamMaker vButton1, Create Team
Gui, Add, BUTTON,w80 x700 y320 gEditTeamFile vButton2, Edit File
startY := startY + 160
Gui, Add, Text, % " x"startX+350 " y"startY  " h"30 " vText1", ADD AN ACCOUNT
startY := startY + 20
startY := startY +25

Gui, Add, Text,% " x" startX+275  " y"startY " h"25 " vText2", ID
Gui, Add, Edit,% " x" startX+315  " y"startY " h"25 " cblack" " vId",
startY := startY +35
Gui, Add, Text,% " x" startX+275  " y"startY " h"25  " vText3", PW
Gui, Add, Text,% " x" startX+315  " y"startY " h"25 " vText4", PASSWORD

Gui, Add, Edit,% " x" startX+315  " y"startY " h"25 " cblack" " vMdp",
startX := startX +200
startY := startY +25

startX := 40
startY := startY +10
Gui, Add, BUTTON,% " x" startX+330  " y"startY " w"95 " h"25 " gEditFile" " vEditFileButton", Edit File
startX := startX+100
Gui, Add, Button,% " x" startX+330 " y"startY " w"80 " h"25 "default" " gRegisterAccountToFile" " vAddAccToFile", Add
startX := startX+100



Gui, Add, Picture,% " x" startX+450 " y"startY-80 " vPicture1", %my_picturefile%	
...
Gui, Add, Button,% " x"startX " y"startY " w"208 " h"25 "default" " gHideEverything" " vSwitchPage", Auto Pairing - Link Char
Gui, Add, Button,% " x"startX " y"startY+30 " w"208 " h"25 "default" " gHideEverything2" " vSwitchPage2", Settings
startX := 80
startY = 100
count := 1
...
for key, val in account {
	Gui, Add,Text, % "x"startX " y"startY " vAccountText" A_Index, %key%

	IniRead, charName, pairing.ini,Accounts,%key%,%A_Space%
	IniRead,ServerSlot, pairing.ini,Accounts,% charName "Server",%A_Space%
	IniRead,CharSlot, pairing.ini,Accounts,% charName "Char",%A_Space%
	if(charName=="ERROR"){
		charName:=""
	}
	Gui, Add, Edit ,% "x"startX " y"startY+30 " w"100 " h"30 " cBlack" " vAccountNumber" A_Index, %charName%
	Gui, Add,Text, % "x"startX+115 " y"startY " vAccountServerSlotTxt" A_Index, S
	Gui, Add, Edit ,% "x"startX+110 " y"startY+30 " w"20 " h"30 " cBlack" " vAccountServerSlot" A_Index,%ServerSlot%
	Gui, Add,Text, % "x"startX+145 " y"startY " vAccountCharSlotTxt" A_Index, C
	Gui, Add, Edit ,% "x"startX+140 " y"startY+30 " w"20 " h"30 " cBlack" " vAccountCharSlot" A_Index, %CharSlot%
	startX := startX + 200
...
Gui, Add, GroupBox,% " x" startX   " y"startY " w"EightSettings " h"100 " vGroupBoxLogin", % " Log In   "
startX := startX+25
Gui, Add, Text,% " x" startX   " y"startY+30  "h" 30 " vText10", L.I Delay
Gui, Add, Edit, % " x" startX   " y"startY+60 " w"90 " h"25 " vAutoLogInDelay" " cblack", %AutoLogInDelay%
startX := startX + 110
Gui, Add, Text,% " x" startX   " y"startY+30  "h" 30  " vText11", S.D Delay
Gui, Add, Edit, % " x" startX   " y"startY+60 " w"90 " h"25 " vStartDofusDelay" " cblack", %StartDofusDelay%
startX := startX + 110
Gui, Add, Text, % " x" startX " y"startY+30 " h"25  " vText12",ID Pos
Gui, Add,Button,% " x" startX   " y"startY+60 " w"95 " h"25 " gCoordinatesLogInID" " vIdPosX", (X1,Y1)
startX := startX + 110
Gui, Add, Text, % " x" startX " y"startY+30 " h"25  " vText13",PW Pos
Gui, Add,Button,% " x" startX   " y"startY+60 " w"95 " h"25 " gCoordinatesLogInPW" " vIdPosY", (X2,Y2)
startX := startX + 110
Gui, Add, Text, % " x" startX " y"startY+30 " h"25  " vText14",Sniper Mode

if(EnableSniper){
	Gui,Add, Checkbox,% " x" startX+40   " y"startY+60 " h"25 " vEnableSniper" " gEnableSniperMode" " checked" ,

} else {
	Gui,Add, Checkbox,% " x" startX+40   " y"startY+60  " h"25 " vEnableSniper" " gEnableSniperMode",

}
startX := startX + 110
Gui, Add, Text, % " x" startX " y"startY+30  " h"25  " vText22", Delay ID/MDP (ms)
Gui, Add, Edit, % " x" startX  " y"startY+60 " w"90 " h"25 " cblack" " vDelayClickAfterLoadingScreen"  , %DelayClickAfterLoadingScreen%
...
Gui, Add, GroupBox,% " x" startX   " y"startY " w"EightSettings " h"200  " vText15", % " Auto Select Server and Character  "
startX := startX+25
Gui, Add, Text, % " x" startX " y"startY+30 " h"25  " vText16", SLOT 1
Gui, Add,Button,% " x" startX   " y"startY+60 " w"95 " h"25 " gCoordinatesSlot1" " vSlot1Pos", (X,Y)
startX := startX + 110
Gui, Add, Text, % " x" startX " y"startY+30 " h"25  " vText17", SLOT 2
Gui, Add,Button,% " x" startX   " y"startY+60 " w"95 " h"25 " gCoordinatesSlot2" " vSlot2Pos", (X,Y)
startX := startX + 110
Gui, Add, Text, % " x" startX " y"startY+30 " h"25  " vText18",SLOT 3
Gui, Add,Button,% " x" startX   " y"startY+60 " w"95 " h"25 " gCoordinatesSlot3" " vSlot3Pos", (X,Y)
startX := startX + 110
Gui, Add, Text, % " x" startX " y"startY+30 " h"25  " vText19",SLOT 4
Gui, Add,Button,% " x" startX   " y"startY+60 " w"95 " h"25 " gCoordinatesSlot4" " vSlot4Pos", (X,Y)
startX := startX + 110
Gui, Add, Text, % " x" startX " y"startY+30 " h"25  " vText20",SLOT 5
Gui, Add,Button,% " x" startX   " y"startY+60 " w"95 " h"25 " gCoordinatesSlot5" " vSlot5Pos", (X,Y)
startX := startX + 110
Gui, Add, Text, % " x" startX " y"startY+30 " h"25  " vText21",A-Select S/C

if(AutoSelect){
	Gui,Add, Checkbox,% " x" startX+40   " y"startY+60 " h"25 " vAutoSelect" " gEnableAutoSelect" " checked",
} else {
	Gui,Add, Checkbox,% " x" startX+40   " y"startY+60  " h"25 " vAutoSelect" " gEnableAutoSelect",
}
...
startX := startx+25
startY:=starty+90
Gui, Add, Text, % " x" startX " y"startY+30  " h"25  " vText24", Delay Log/Serv (ms)
Gui, Add, Edit, % " x" startX  " y"startY+60 " w"90 " h"25 " cblack" " vAutoLogInDelayBetweenLogAndServer" , %AutoLogInDelayBetweenLogAndServer%
startX := startX + 200
Gui, Add, Text, % " x" startX " y"startY+30  " h"25  " vText26", Delay Serv/Char (ms)
Gui, Add, Edit, % " x" startX  " y"startY+60 " w"90 " h"25 " cblack" " vAutoLogInDelayBetweenServerAndCharacter", %AutoLogInDelayBetweenServerAndCharacter%
